...
if tourney == 'PGF Show Me The Money Showcase':
    ...
    age_group = st.sidebar.multiselect('Select Age Group', data['Age Group'].unique())
    ...
    teams = st.sidebar.multiselect('Select Teams', teams)
    ...
    filtered_data = filtered_data[['Away', 'Home', 'Time', 'Field']]
